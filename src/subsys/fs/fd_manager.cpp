...
void FdManager::release_fd(int fd) { allocated_fds_.erase(fd); }
...
template void
FdManager::serialize<cereal::BinaryInputArchive>(cereal::BinaryInputArchive &);
template void FdManager::serialize<cereal::BinaryOutputArchive>(
