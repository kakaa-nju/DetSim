...
const CommandEntry *get_command_table() { return cmd_table; }

size_t get_command_count() { return sizeof(cmd_table) / sizeof(cmd_table[0]); }
...
int cmd_x(char *args)
{
  ...
  for (int i = 0; i < count; i++)
  {
    ...
    {
      case 1:
        val = tracee_read_byte(pid, (void *)(addr + i));
        break;
      case 2:
        val = tracee_read_word(pid, (void *)(addr + i * 2)) & 0xFFFF;
        break;
      case 4:
        val = tracee_read_word(pid, (void *)(addr + i * 4)) & 0xFFFFFFFF;
        break;
      case 8:
        val = tracee_read_word(pid, (void *)(addr + i * 8));
        break;
    }
    ...
    {
      case 'x':
        detsim::ui::ui_printf("%0*lx ", size * 2, val);
        break;
      case 'd':
        detsim::ui::ui_printf("%*ld ", size * 3, (int64_t)val);
        break;
      case 'u':
        detsim::ui::ui_printf("%*lu ", size * 3, val);
        break;
      case 'o':
        detsim::ui::ui_printf("%0*lo ", size * 3, val);
        break;
      default:
        detsim::ui::ui_printf("%0*lx ", size * 2, val);
        break;
