...
struct ThreadSchedInfo {
    ...
    ThreadSchedInfo() : thread_idx(0), virtual_tid(0), physical_tid(0),
...
public:
    ...
    int add_thread(pid_t physical_tid, uint64_t clone_flags,
                   uint64_t stack_addr, pid_t parent_tid, bool is_main = false);
